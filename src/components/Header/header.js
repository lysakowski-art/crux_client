      ...
      <Navbar bg="dark" expand="lg" variant="dark">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto">
            ...
            <Nav.Link as={Link} to="/add_route">{t("add_route")}</Nav.Link>
            <Nav.Link as={Link} to="/routes">{t("routes")}</Nav.Link>
            <Nav.Link as={Link} to="/about">{t("about")}</Nav.Link>
            <Nav.Link as={Link} to="/contact">{t("contact")}</Nav.Link>
            <Nav.Link as={Link} to="/sign" className="login-register">{t("login")} / {t("register")}</Nav.Link>
          </Nav>
