...
const AddRoute = () => {
  ...
  },[routeTitle,routeAuthor,routeRank,routeType,region,bolts,routeDescription,userName])
  ...
  return loggedIn ? (
    <Row className="add-route justify-content-md-center">
      <Form>
        ...
        <AddRouteInput name="expansion_bolts/placemant" type="number" value={bolts} setValue={setBolts} checkbox={true} checkboxValue={routeType} setCheckboxValue={setRouteType}/>
